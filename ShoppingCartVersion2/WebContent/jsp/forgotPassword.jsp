...
<link rel="stylesheet" type="text/css" href = "/ShoppingCartVersion2/css/register.css">
</head>
<body>
<form action = "/ShoppingCartVersion2/jsp/forgotPasswordValidation.jsp" method ="post">
<div class="box" >
